...
public class Avocados implements ModInitializer {
	...
	public static final Feature<RandomPatchFeatureConfig> FUCHSIA_CONFIG = Feature.FLOWER;
	public static ConfiguredFeature<RandomPatchFeatureConfig,RandomPatchFeature> FUCHSIA_FEATURE = new ConfiguredFeature<>(
			(RandomPatchFeature)FUCHSIA_CONFIG, ConfiguredFeatures.createRandomPatchFeatureConfig(64,PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Avocados.FUCHSIA_FLOWER)))));
	public static RegistryEntry<PlacedFeature> FUCHSIA_PLACED = PlacedFeatures.register("fuchsia_placed",RegistryEntry.of(FUCHSIA_FEATURE), RarityFilterPlacementModifier.of(15), SquarePlacementModifier.of(),
			BiomePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP);
	...
	public void onInitialize() {
		...
		regItem("beesechurger",BEESECHURGER);
		regItem("raw_platinum", RAW_PLATINUM);
		regItem("platinum_ingot",PLATINUM_INGOT);
		regItem("platinum_nugget", PLATINUM_NUGGET);
		regItem("cooked_beetroot",COOKED_BEET);
		regItem("platinum_beetroot",PLAT_BEET);
		regBlock("platinum_block",PLAT_BLOCK, ItemGroup.BUILDING_BLOCKS);
		regItem("platinum_potato",PLAT_POTATO);
		regItem("netherite_nugget",NETHERITE_NUGGET);
		regBlock("raw_platinum_block", RAW_PLAT_BLOCK, ItemGroup.BUILDING_BLOCKS);
		regItem("platinum_steak",PLAT_STEAK);
		regBlock("platinum_ore",PLAT_ORE, ItemGroup.BUILDING_BLOCKS);
		regItem("platinum_helmet", new BaseArmor(PLAT_ARMOUR, EquipmentSlot.HEAD));
		regItem("platinum_chestplate", new BaseArmor(PLAT_ARMOUR, EquipmentSlot.CHEST));
		regItem("platinum_leggings", new BaseArmor(PLAT_ARMOUR, EquipmentSlot.LEGS));
		regItem("platinum_boots", new BaseArmor(PLAT_ARMOUR, EquipmentSlot.FEET));
		regItem("platinum_pickaxe", new PlatPick(new ToolMaterialPlatinum()));
		regItem("platinum_axe", new PlatAxe(new ToolMaterialPlatinum()));
		...
		regBlock("teal_glazed_terracotta",TEAL_GLAZED_TERRACOTTA,ItemGroup.BUILDING_BLOCKS);
