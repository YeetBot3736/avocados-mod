...
import potato.avocados.item.PlatAxe;
import potato.avocados.item.PlatHoe;
import potato.avocados.item.PlatPick;
import potato.avocados.item.PlatShovel;
import potato.avocados.item.PlatSword;
import potato.avocados.item.ToolMaterialPlatinum;
...
public class Avocados implements ModInitializer{
	...
	public static final Block RAW_PLAT_BLOCK = PLAT_BLOCK;
	...
	public static final MapColor FUCHSIA = MapColorMixin.callConstructor(63, 13249682);
	...
	public static final Block TEAL_STAINED_GLASS = new StainedGlassBlock(TEAL_COLOR, FabricBlockSettings.of(Material.GLASS).strength(3.0f,3.0f).sounds(BlockSoundGroup.GLASS));
	public static final Block TEAL_STAINED_GLASS_PANE = new StainedGlassPaneBlock(TEAL_COLOR, FabricBlockSettings.of(Material.GLASS).strength(3.0f,3.0f).sounds(BlockSoundGroup.GLASS));
	...
	public static final Block FUCHSIA_STAINED_GLASS = new StainedGlassBlock(FUCHSIA_COLOR, FabricBlockSettings.of(Material.GLASS).strength(3.0f,3.0f).sounds(BlockSoundGroup.GLASS));
	public static final Block FUCHSIA_STAINED_GLASS_PANE = new StainedGlassPaneBlock(FUCHSIA_COLOR, FabricBlockSettings.of(Material.GLASS).strength(3.0f,3.0f).sounds(BlockSoundGroup.GLASS));
	...
	public static ShulkerBoxBlock createShulkerBoxBlock(DyeColor color, AbstractBlock.Settings settings) {
	...
	private static ConfiguredFeature<?, ?> ORE_PLATINUM = Feature.ORE
			.configure(new OreFeatureConfig(
					new BlockMatchRuleTest(Blocks.END_STONE),
					PLAT_ORE.getDefaultState(), 12
			));
	private static PlacedFeature ORE_PLATINUM_THE_END = ORE_PLATINUM.withPlacement(CountPlacementModifier.of(2), SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.getBottom(),YOffset.fixed(80)));
	private static ConfiguredFeature<?, ?> NETHER_PLATI_ORE = Feature.ORE
			.configure(new OreFeatureConfig(OreConfiguredFeatures.BASE_STONE_NETHER,
					NETHER_PLAT_ORE.getDefaultState(), 7
			));
	private static PlacedFeature NETHER_PLATINUM_ORE = NETHER_PLATI_ORE.withPlacement(CountPlacementModifier.of(5),SquarePlacementModifier.of(), HeightRangePlacementModifier.uniform(YOffset.getBottom(),YOffset.fixed(85)));
  ...
  public void onInitialize() {
    ...
    BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier("avocados","platinum_ore")));
	  ...
	  Registry.register(Registry.ITEM, new Identifier("avocados","teal_glazed_terracotta"),new BlockItem(TEAL_GLAZED_TERRACOTTA, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS)));
		...
		regBlock("fuchsia_glazed_terracottta", FUCHSIA_GLAZED_TERRACOTTA, ItemGroup.BUILDING_BLOCKS);
		...
		//No need any BlockItem for WallBanners
...
//Thanks to mycf#6231, JoeMama#7129, Yeyito#1834, KaloyanKYS#5185 and Velimoss#0330, together with the whole of Suited Llama's Community and Fabriccord for helping with thi