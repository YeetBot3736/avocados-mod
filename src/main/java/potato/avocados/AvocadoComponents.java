...
public class AvocadoComponents {
    ...
    public static final FoodComponent PLAT_BEET = (new FoodComponent.Builder()).hunger(9).saturationModifier((float)1.6).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION,600,4),0.77F).build();
    public static final FoodComponent PLAT_POTATO = (new FoodComponent.Builder()).hunger(15).saturationModifier((float)1.8).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE,18000,0),1.00F).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE,18000,24),1.00F).statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH,18000,9),1.00F).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION,18000,14),1.00F).build();
